...
//   final TextEditingController controller = RichTextEditingController();
...
//     super.initState();
//     controller.text =
//         'hol ouajod dnfoiasf modsafodsafnasdfdas dfdsfsad fdadsf dsfdafs s dfe  vsdf ferwef qefqewfeqw fqfewfe qwf qewfqw qfwe eqfqwe';
//     focusNode.requestFocus();

//     controller.addListener(() {
//       // // final String text = controller.text;
//       // // final List<String> words = text.split(' ');
//       // // final int start = text.length - words.last.length;
//       // // final int end = text.length;
//       // // controller.value = controller.value
//       // //     .copyWith(composing: TextRange(start: start, end: end));
//     });
//   }
...
//       child:
//           // onPointerDown: (event) => controller.selection =
...
import 'package:block_text_editor/rich_text_editing_controller.dart';
import 'package:flutter/material.dart';
...
class _RichTextFieldSelectionGestureDetectorBuilder
...
class _RichTextFieldState extends State<RichTextField>
  ...
  late _RichTextFieldSelectionGestureDetectorBuilder
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder =
        _RichTextFieldSelectionGestureDetectorBuilder(state: this);
